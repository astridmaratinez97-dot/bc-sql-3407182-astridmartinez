...
SELECT
    ...
    SUM(duration_months) AS suma_duracion,
    AVG(duration_months) AS promedio_duracion
FROM programs;
...
SELECT
    MIN(duration_months) AS duracion_minima,
    MAX(duration_months) AS duracion_maxima
FROM programs;
...
-- ============================================
-- REPORTE 5: WHERE + GROUP BY + HAVING
-- ============================================
